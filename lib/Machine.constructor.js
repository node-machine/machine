...
Machine.prototype.setExits = function (callbacks) {
  ...
  //   callbacks.error = callbacks[self.catchallExit];
  // }
  ...
  //   callbacks.success = callbacks[self.defaultExit];
  // }
  ...
  // var switchbackifiedExits = switchback(callbacks, forwards, undefined, true);
