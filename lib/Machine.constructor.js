...
function Machine (machineDefinition) {
  ...
  // default max recursive call depth to 250
  this.maxRecursion = machineDefinition.maxRecursion || 250;
  ...
  this._configuredEnvironment = {
    ...
    thisMachine: function (){
      ...
      recursiveMachineInstance._recursiveDepth = (self._recursiveDepth||0)+1;
      if (recursiveMachineInstance._recursiveDepth > self.maxRecursion) {
        self.constructor.build(function (inputs, exits){
          return exits.error( util.format(
