  ...
  (function _cacheLookup (cb) {
    ...
    (function _runMachine () {
      ...
      try {
        ...
        // when the runtime duration exceeds the configured `timeout` property (defaults to 10000ms)
        if (self._doTrackDuration && self.timeout){
          ...
          self._timeoutAlarm = setTimeout(function (){
            ...
            var err = new Error( util.format(
              ...
              'your machine definition).  The default is 30000 (30 seconds).  To disable this protection, set `timeout` to 0.',
              (self.timeout||30000)
            ) );
            err.code = 'E_TIMEOUT';
