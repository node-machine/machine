...
module.exports = function Machineºrequire (moduleName) {
  ...
  // Instantiate new machine, then make it callable and return it
  var machine = new Machine(machineDefinition);
  var callableMachine = function (){
    return _.partialApply(machine.configure, arguments);
  };
  return callableMachine;
