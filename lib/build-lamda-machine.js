...
module.exports = function buildLamdaMachine(runtimeLamdaFn, nameOfLamdaInput, parentMachine){
  ...
  var lamdaMachineDef = {
    ...
    inputs: _.reduce(parentLamdaInput.contract.provides, function buildEachInputDefForLamdaMachine(memo, def, name){
    ...
    exits: _.reduce(parentLamdaInput.contract.expects, function buildEachExitDefForLamdaMachine(memo, def, name){
