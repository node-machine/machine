...
module.exports = function build(nmDef){
  ...
  var isProduction = (function(){
    var _isProductionNodeEnv = typeof process !== 'undefined' && process.env.NODE_ENV === 'production';
    var _isProductionWindow = typeof window !== 'undefined' && window.environment === 'production';
      ...
      function (done){
        ...
        switch (nmDef.implementationType) {
          ...
          case undefined:
            ...
            var implSideExitHandlerCbs = _gettingHandlerCbs(done, omen, exitDefs);
...
function _gettingHandlerCbs(done, omen, exitDefs){
