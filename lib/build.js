...
var normalizeMachineDef = require('./private/normalize-machine-def');
var normalizeArgins = require('./private/normalize-argins');
        ...
        switch: function (userlandHandlers) {
          ...
          this.exec(function (err, result){
            ...
            if (err) {
              ...
              // TODO: figure out a way to safely do this, even in prod!
