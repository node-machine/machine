...
module.exports = function determineEffectiveOutputExample (exitDef, exitName, allConfiguredInputValues, machineDef) {
  ...
  // (Note that we could use `rttc.coerceExemplar()` to keep the implementation the same
  //  plus add support for nested multi-item arrays, but it's more straightforward for
  //  implementors if we do an assertion.  It's also a bit more performant.)
  ///////////////////////////////////////////////////////////////////////////////////////
