 ...
 * @param  {Object} machineInstance
 * @return {Object} of new callbacks which intercept the configured callback functions
 */
module.exports = function interceptExitCallbacks (callbacks, _cache, hash, self){
      ...
      memo[exitName] = function _interceptExit(value) {
        ...
        if(self._exitCoercion && !voided) {
          ...
          if(!_.isUndefined(schema)) {
            try {
              value = rttc.rttc(schema, value, { coerce: self._exitCoercion, base: true });
            } catch (err) {
    ...
    memo[exitName] = function _interceptExitAndCacheResult(data) {
      ...
      .exec(function(err) {
        ...
        if(self._exitCoercion) {
          ...
          if(schema) {
            try {
              rttc.rttc(typeDef, data, { coerce: self._exitCoercion, base: true });
            } catch (e) {
