        ...
        switch: function (userlandHandlers) {
          ...
          this.exec(function (err, result){
            ...
            if (err) {
              ...
              if (err.name === 'Exception' && err.traceRef === traceRef) {
                // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
