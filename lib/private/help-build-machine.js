      ...
      function (done){
        ...
        switch (nmDef.implementationType) {
          ...
          case 'analog':
            ...
            var validationProblems = normalizeArgins(argins, arginValidationTactic, extraArginsTactic, nmDef, rtOmen);
          ...
          if (extraCallbacksTactic !== 'doNotCheck') {
            ...
            if (unrecognizedExitCodeNames.length > 0) {
              ...
              if (extraCallbacksTactic === 'warnAndOmit') {
                console.warn(
                  '- - - - - - - - - - - - - - - - - - - - - - - -\n'+
                  'WARNING: '+extraCallbacksErrorMsg+'\n'+
                  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                  // FUTURE: Include stack trace here, if rtOmen is truthy.
                  // (See the handling of similar logic in `normalize-argins` for an example.)
                  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                  '- - - - - - - - - - - - - - - - - - - - - - - -'
                );
              }//ﬁ
