                ...
                handlerCbs.error = function(rawOutput){
                  ...
                  if (undefined === rawOutput) {
                    ...
                    if (rawOutputParsedAsErr) {
                      ...
                      // Check the Error instance to see if it indicates any special meaning, whether that be
                      // an `Exception` or argin validation error.
                      // - - - - - - - - - - - - - - - - - - - -
                      // FUTURE: Include TimeoutError here too
                      // - - - - - - - - - - - - - - - - - - - -
                      //
      ...
      // Extra methods for the Deferred:
      {
        ...
        now: function (){
          ...
          try {
            ...
            // Note: This is a parley traceRef -- not ours!
            // (Thus we expect it to point at a Deferred -- not at our private `{}` defined above.)
            //
            // TODO: pull this check into parley so it's not necessary to do it in userland
