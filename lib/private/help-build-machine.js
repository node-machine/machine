...
module.exports = function helpBuildMachine(opts, btOmen) {
  ...
  //```
  // var arginValidationTactic = opts.arginValidationTactic || 'doNotCheck';
    ...
    switch (arginStyle) {
      ...
      case 'serial':
        ...
        _.each(arguments, function(argin, i){
          ...
          if (!supposedInputName) { throw new Error('Consistency violation: Invalid usage with serial arguments: Received unexpected '+(i===0?'first':i===1?'second':i===2?'third':(i+1)+'th')+' argument.'); }
