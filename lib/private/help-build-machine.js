          ...
          case undefined:
            ...
            if (nmDef.fn.constructor.name === 'AsyncFunction') {
              ...
              try {
                ...
                if (_.isString(specialExitSignal) && implSideExitHandlerCbs[specialExitSignal]) {
                  return implSideExitHandlerCbs[specialExitSignal]();
                }
                else if (_.isObject(specialExitSignal) && _.isString(specialExitSignal.exit) && implSideExitHandlerCbs[specialExitSignal.exit]) {
                  return implSideExitHandlerCbs[specialExitSignal.exit](specialExitSignal.output);
                }
                else {
