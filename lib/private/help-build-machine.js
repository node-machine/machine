              ...
              (function _attachingHandlerCbs(proceed){
                ...
                handlerCbs.error = function(rawOutput){
                  ...
                  if (undefined === rawOutput) {
                    ...
                    // then it might be messier.  It *could* be truncated, but that could defeat the
                    // usefulness somewhat.
                    //
                    ...
                    //
                    // **Also note: a good place to handle this, or even just partially handle this,
                    // might be in flaverr, as a special-case behavior when doing `.wrap('E_NON_ERROR',…)`**
                    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                    err = flaverr({
                      name: 'Error',
