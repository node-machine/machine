          ...
          case 'analog':
            ...
            var implSideExitHandlerCbs = (function _gettingHandlerCbs(){
              ...
              (function _attachingHandlerCbs(proceed){
                ...
                handlerCbs.error = function(rawOutput){console.log('•••called implSideExitHandlerCbs.error!', rawOutput);
                ...
                handlerCbs.success = function(rawOutput){console.log('•••called implSideExitHandlerCbs.success!', rawOutput);
                ...
                _.each(_.difference(_.keys(nmDef.exits), ['error','success']), function (miscExitCodeName){
                  handlerCbs[miscExitCodeName] = function (rawOutput){console.log('•••called implSideExitHandlerCbs.'+miscExitCodeName+'!', rawOutput);
