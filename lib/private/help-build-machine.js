          ...
          case undefined:
            ...
            if (nmDef.fn.constructor.name === 'AsyncFunction') {
              ...
              try {
                ...
                specialExitSignal = _.isString(err) ? err : (_.isObject(err) && err.name === 'Envelope' && err.code === 'E_NON_ERROR' && _.isString(err.raw)) ? err.raw : undefined;
                if (specialExitSignal && implSideExitHandlerCbs[specialExitSignal]) {
