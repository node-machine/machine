    ...
    var deferredObj = parley(
      ...
      function (done){
        ...
        switch (nmDef.implementationType) {
          ...
          case 'classical':
            // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
            // FUTURE: Support automatically mapping this to the "classical" implementation type:
