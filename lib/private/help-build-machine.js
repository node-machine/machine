          ...
          case undefined:
            ...
            if (nmDef.fn.constructor.name === 'AsyncFunction') {
              ...
              try {
                ...
                else if (!_.isError(specialExitSignal) && !_.isArray(specialExitSignal) && _.isObject(specialExitSignal) && _.keys(specialExitSignal).length === 1 && implSideExitHandlerCbs[_.keys(specialExitSignal)[0]]) {
