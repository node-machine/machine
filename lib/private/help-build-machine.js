    ...
    var deferredObj = parley(
      ...
      function (done){
        ...
        switch (nmDef.implementationType) {
          ...
          case 'string:js':
            return done(flaverr({name:'UsageError', message: 'This runner doesn\'t know how to interpret and execute a code string (`implementationType: \'string:js\'`).  Could you use `eval()` on it first to get a hydrated function, and then change the declared `implementationType` to `classic` or `analog`?\n'+GENERIC_HELP_SUFFIX}, rtOmen));
          ...
          case 'abstract':
            // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
            // FUTURE: Still do the argin checks etc, and then have the machine PRETEND to execute,
          ...
          case 'classic':
            // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
            // FUTURE: Support automatically mapping this to the "classic" implementation type:
