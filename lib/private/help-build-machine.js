        ...
        _.reduce(nmDef.inputs, function (memo, inputDef, inputCodeName){
          ...
          if (inputDef.type) {
            ...
            if (displayTypeInferredFromExample === 'string' || displayTypeInferredFromExample === 'number') {
              ...
              memo += '     (type: '+displayTypeInferredFromExample+')';
            }
          }
