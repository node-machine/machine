            ...
            switch (err.code) {
              case 'E_INVALID':
                _.each(err.errors, function(subError){
                  arginProblems.push({
                    details: 'Invalid "'+inputCodeName+'".  '+subError.message
                      // subError.actual === undefined?
                      // 'Missing "'+inputCodeName+'".  (Expecting '+subError.actual+')'
                      // :
                      // 'Invalid "'+inputCodeName+'".  ('+subError.message+')'
                  });
                });
                break;
              default:
