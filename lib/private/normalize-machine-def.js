...
module.exports = function normalizeMachineDef(nmDef){
  ...
  if (nmDef.implementationType !== undefined) {
    if (nmDef.implementationType !== 'abstract' && nmDef.implementationType !== 'composite' && nmDef.implementationType !== 'classic' && nmDef.implementationType !== 'analog' && nmDef.implementationType !== '') {
      implProblems.push('Invalid `implementationType` property.  (If specified, must be \'abstract\', \'composite\', \'classic\', or \'analog\'.)');
    }
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
